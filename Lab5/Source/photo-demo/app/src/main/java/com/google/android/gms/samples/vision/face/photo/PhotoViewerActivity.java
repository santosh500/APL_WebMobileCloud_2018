...
public class PhotoViewerActivity extends Activity {
    ...
    public FaceView overlay;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_photo_viewer);

        InputStream stream = getResources().openRawResource(R.raw.paul1);
        ...
        //leftEye = overlay.leftEye;
        Log.i("LEFT 5EYE", leftEye);
    ...
    {
        Intent loginPage = new Intent(PhotoViewerActivity.this,Results.class);
        Log.i("LEFT EYE", overlay.leftEye);
        Log.i("Right EYE", overlay.rightEye);
        Log.i("Smile", overlay.smileMain);
        loginPage.putExtra("LEye",overlay.leftEye);
        loginPage.putExtra("REye",overlay.rightEye);
        loginPage.putExtra("Smile",overlay.smileMain);
